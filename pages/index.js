    ...
    <div className="lg:w-4/6 mx-auto">
      ...
      <div className="flex flex-col sm:flex-row mt-10">
        <div className="sm:w-1/3 text-center sm:pr-8 sm:py-8">
          ...
          <Image alt="content" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" strokeWidth="2" className="h-full w-full" viewBox="0 0 24 24" width={1200} height={1200} src="/profile.png"/>
          </div>
